...
export const serviceCategories: ServiceCategory[] = [
  ...
  // --------------------------------------------------------------------
  {
    ...
    process: [
      ...
      { title: 'Launch', description: 'Domain connection, Search Console configuration, and a final pass on speed and mobile rendering.' },
    ],
    packages: [
      {
        id: 'web-starter',
        ...
        addons: [
          ...
          addonInrOnly('Monthly website maintenance', 1500, 'monthly'),
          addonInrOnly('Annual website maintenance', 12000, 'yearly'),
        ],
        delivery: '3–4 days',
      },
      {
      ...
      },
      {
        ...
        addons: [addonInrOnly('Monthly website maintenance', 1500, 'monthly'), addonInrOnly('Annual website maintenance', 12000, 'yearly')],
        delivery: '10–14 days',
      },
    ],
    faqs: [
      ...
      },
      {
        ...
        answer:
          'One-time website payment covers the build, launch and handover. After that, you maintain the site yourself. If you want Kraftt Digital to maintain the site, handle small content updates, keep the site healthy, and make normal changes for you, maintenance is Rs. 1,500/month or Rs. 12,000/year for every website package. New features, new sections, advanced integrations, or larger scope additions are priced separately.',
      },
      {
    ...
    packages: [
      {
        ...
        featured: false,
        price: price(299, 12000),
        includes: ['Logo suite (primary, secondary, icon)', 'Primary colour palette', 'Typography', 'Brand voice and tone guide'],
  ...
  // --------------------------------------------------------------------
  {
    ...
    packages: [
      ...
      },
      {
        ...
        includes: [
          ...
          '20 stories/month',
          '3 platforms managed',
          '4 reels/month (typography or educational reels with visuals and illustrations; shoot not included)',
          'Hashtag and caption research',
          'Strategy and growth analytics',
        ],
        addons: [],
        delivery: 'Ongoing monthly',
      },
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Community management is not included in the listed social media packages by default. These packages focus on content creation, publishing, captions, hashtags, profile management and analytics. DM or comment replies can be scoped separately if needed.',
      },
    ],
